  ...
  <div id="image">
    <div id="stitle"><strong><center>
      <p>Size Uygun Tekliflerimizden Yararlanabilmeniz İçin!</p>
        ...
        <input id="input" value placeholder="Mail Adresiniz" />
        <a href="#" id="button">Takip Et!</a>
        <img class="lang" src="../s/img/UnitedKingsom.png" />
    	<a class="lang" href="/" />
    </div>
    
    <div id="softw">
    	<a href="../s/img/softw1.png"><img id="softw1" src="../s/img/softw1.png" /></a>
        <a href="../s/img/softw2.png"><img id="softw2" src="../s/img/softw2.png" /></a>
    </div>
